  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="디데이를 계산하는 도구입니다. 이 디데이 계산기는 특정 날짜까지 남은 일수를 계산하는 도구입니다. 기준일과 목표 날짜를 선택하고, 기준일 포함 여부를 설정하면 남은 일수를 확인할 수 있습니다."
        />
      ...
      <div className="wide-container">
        <div className="container">
          <div className="small-container">
            ...
            <div className="result">
              <p className="result-text">
                <strong>디데이까지 남은 일수: {daysRemaining}일</strong>
              </p>
            </div>
          </div>
          ...
          <div className="info">
            ...
            <br />
            <p>
              이 디데이 계산기는 특정 날짜까지 남은 일수를 계산하는 도구입니다. 기준일과 목표 날짜를 선택하고, 기준일
              포함 여부를 설정하면 남은 일수를 확인할 수 있습니다.
            </p>
            <br />
            <p>
              기준일은 디데이 계산의 기준이 되는 날짜로 설정되며, 목표 날짜는 디데이를 계산할 대상 날짜입니다. 기준일을
              포함할지 여부를 설정하여 디데이 계산 결과를 조정할 수 있습니다.
            </p>
            <br />
            <p>
              또한, '기준일 포함' 옵션을 선택하면, 디데이 계산 시 기준일을 1일로 카운트하여 결과를 표시합니다. 이를 통해
              기준일 당일도 디데이로 확인할 수 있습니다.
            </p>
            <br />
            <p>
              계산된 디데이 남은 일수는 디데이까지 얼마나 남았는지 빠르게 확인할 수 있도록 도와줍니다. 중요한 날짜나
              이벤트까지 얼마나 남았는지를 쉽게 파악하여 준비를 할 수 있습니다.
            </p>
            <br />
            <p>디데이 계산을 편리하게 하고 싶다면 이 디데이 계산기를 활용하세요.</p>
          </div>
        </div>
      </div>
    </div>
