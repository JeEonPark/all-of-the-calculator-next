  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="마일과 킬로미터를 변환하는 변환 도구입니다." />
      ...
      <div className="wide-container">
        <div className="container">
          ...
          <div className="info">
            ...
            <p>
              마일과 킬로미터를 변환하는 간단한 도구입니다.
              입력된 마일을 킬로미터로 변환하거나, 입력된 킬로미터를 마일로 변환할 수 있습니다.
            </p>
            ...
            <h3>변환 공식:</h3>
            <p>
              마일(mile)을 킬로미터(km)로 변환하는 공식: 킬로미터 = 마일 × 1.60934
            </p>
            <br />
            <p>
              킬로미터(km)를 마일(mile)로 변환하는 공식: 마일 = 킬로미터 ÷ 1.60934
            </p>
            ...
            <h3>예시:</h3>
            <p>
              - 10 마일을 킬로미터로 변환하면: 10 × 1.60934 ≈ 16.0934 km
            </p>
            <p>
              - 20 킬로미터를 마일로 변환하면: 20 ÷ 1.60934 ≈ 12.4274 mile
            </p>
          </div>
        </div>
      </div>
