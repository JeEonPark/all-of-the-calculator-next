      ...
      <div className="wide-container">
        <div className="container">
          ...
          <div className="row">
            <Tool
              title="2진수 10진수 변환기"
              link="/math/binary-decimal-converter"
            />
            <Tool
              title="2진수 8진수 변환기"
              link="/math/binary-octal-converter"
            />
            <Tool
              title="2진수 16진수 변환기"
              link="/math/binary-hexadecimal-converter"
            />
            <Tool
              title="8진수 16진수 변환기"
              link="/math/octal-hexadecimal-converter"
            />
            <Tool
              title="10진수 16진수 변환기"
              link="/math/decimal-hexadecimal-converter"
            />
