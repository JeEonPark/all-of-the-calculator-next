  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="10진수와 16진수를 변환하는 간단한 변환 도구입니다." />
      ...
      <div className="wide-container">
        <div className="container">
          ...
          <div className="info">
            ...
            <p>
              10진수 16진수 변환기는 10진수와 16진수를 서로 변환하는 간단한 도구입니다.
              입력된 10진수를 16진수로 변환하거나, 입력된 16진수를 10진수로 변환할 수 있습니다.
            </p>
            <p>
              이 변환기는 사용자가 10진수나 16진수를 입력하면 자동으로 변환 결과를 제공합니다.
            </p>
            <br />
            <h2>더 많은 진수 변환기</h2>
            <ul>
